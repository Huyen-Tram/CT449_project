<template>
	<div class="page row">
		...
		<div class="mt-3 col-md-6 text-info">
			<h4>
			...
			/>
			<p v-else>Không tìm thấy truyện.</p>
		...
		<div class="mt-3 col-md-6">
			<div v-if="activeProject">
				<h4 class="card-header bg-light text-info">
					Chi tiết truyện yêu thích
					...
					>
						<span class="mt-10 badge badge-success
">
